...
export default function Divider({
  ...
  return direction === "horizontal" ? (
    ...
    <>
      ...
      <div className="pointer-events-none fixed top-0 left-1/2 z-10 flex h-full -translate-x-1/2 items-center gap-296 max-md:flex">
        <div className="h-full w-px bg-[#f0f0f0]" />
        <div className="h-full w-px bg-[#f0f0f0]" />
      </div>
      <div className="pointer-events-none fixed top-0 left-1/2 z-10 flex h-full -translate-x-1/2 items-center gap-208 max-md:flex">
        <div className="h-full w-px bg-[#f0f0f0]" />
        <div className="h-full w-px bg-[#f0f0f0]" />
      </div>
    </>
