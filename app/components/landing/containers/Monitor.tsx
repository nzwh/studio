      ...
      <main className="absolute inset-0 flex flex-col gap-2 m-3 text-[#888888]">
        <section className="flex flex-row justify-between w-full cursor-default">
          <div className="flex flex-row items-center gap-2">
            ...
            <h6 className="font-light text-xs tracking-tight">
          ...
          <div className="flex flex-row items-center gap-3">
            ...
            >
              ...
              <span className="font-light text-xs tracking-tight">
                Manila, PH
              </span>
            </div>
        ...
        <section className="@container mb-3 rounded-sm w-full h-full">
          <div
            className="relative shadow-[inset_0_-20px_50px_0_rgba(0,0,0,0.05)] border border-[#f0f0f0] rounded-lg w-full h-full overflow-hidden"
            {...click}
          >
            <canvas
            ...
            <div className="top-3 left-3 absolute flex flex-row items-center gap-1 pointer-events-none">
              <div className="bg-[#dadada] rounded w-1 h-1"></div>
              <div className="bg-[#dadada] rounded w-1 h-1"></div>
              <div className="bg-[#dadada] rounded w-1 h-1"></div>
            </div>
            <span className="top-1/9 left-1/2 -z-10 absolute font-light text-[#c0c0c0] text-[0.5rem] tracking-tight -translate-x-1/2 -translate-y-1/2 pointer-events-none">
              click for a surprise
            </span>
            <span
              className={`${redaction20.className} top-[42%] left-[45%] z-0 absolute font-thin italic [-webkit-text-stroke:2px_#dadada] text-[#ffffff] text-[30rem] tracking-[-4rem] [paint-order:stroke_fill] -translate-x-1/2 -translate-y-1/2 pointer-events-none`}
            >
              nzwh
            </span>
          </div>
        ...
        <section className="bottom-0 left-1/2 z-11 absolute flex flex-row gap-1.5 bg-[#ffffff] shadow-[0_2px_8px_0_rgba(0,0,0,0.04)] px-2 pt-1.5 pb-2 border border-[#f0f0f0] rounded-xl w-fit -translate-x-1/2">
          <KeyButton
            ...
            icon={SiGmail}
            url="mailto:notzerowh@gmail.com"
          />
          <KeyButton
            data-cursor="@arkusgray on x!"
            icon={FaXTwitter}
            url="https://x.com/arkusgray"
          />
          <KeyButton
            data-cursor="@arkusgray on instagram!"
            icon={FaInstagram}
            url="https://instagram.com/arkusgray"
          />
          <KeyButton
            data-cursor="@nzwh on github!"
            icon={FaGithub}
            url="https://github.com/nzwh"
          />
          <KeyButton
            data-cursor="@nzwh on linkedin!"
            icon={FaLinkedin}
            url="https://linkedin.com/in/nzwh"
          />
          <KeyButton
            data-cursor="@nzwh on behance!"
            icon={FaBehance}
            url="https://behance.net/nzwh"
          />
        </section>
      </main>
      <MonitorShape className="w-full h-auto" stroke="#dadada" fill="#ffffff" />
    </main>
  );
}
